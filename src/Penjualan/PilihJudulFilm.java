 ...
 * @author Lenovo
 */
public class PilihJudulFilm extends javax.swing.JFrame {
    ...
    public Stok.InputStok var = new Stok.InputStok();

    /**
     * Creates new form HapusUsers
     */
    public PilihJudulFilm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txtID.setBorder(javax.swing.BorderFactory.createTitledBorder("ID Film"));
    ...
    private void tableDataMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tableDataMouseClicked
        ...
        txtJudul.setText(tableData.getValueAt(tableData.rowAtPoint(evt.getPoint()), 1).toString());
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        x.judul = txtJudul.getText();        
        x.id_film = Integer.parseInt(txtID.getText());
        
        try {
            sql = "SELECT harga_jual AS harga_satuan FROM tbl_film WHERE id_film='" + txtID.getText() + "'";
            res = stat.executeQuery(sql);
            if (res.next()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PilihJudulFilm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PilihJudulFilm().setVisible(true);
            }
        });
    }
